...
<xsl:stylesheet version="3.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
                        ...
                        <div class="profile-card">
                            <div class="avatar-wrapper">
                                <div class="avatar-container">
                                    <img src="/img/avatar.webp" alt="DaXiang" class="avatar" />
                            ...
                            <div class="profile-info">
                                <h1 class="site-title">DaXiang 的个人空间</h1>
                                <p class="site-subtitle">用数据讲故事，用代码构建世界</p>
                                <p class="site-bio">数据开发工程师 | 热爱技术，热爱生活</p>

                                <div class="social-links">
                                                    <a href="https://github.com/DaXiang-ovo" target="_blank" class="social-btn github" title="Github">
                                                        <i class="ri-github-fill"></i>
                                                    </a>
                                                    <a href="mailto:dongxundlut@163.com" target="_blank" class="social-btn email" title="Email">
    ...
    阅读全文 <i class="ri-arrow-right-s-line"></i>
                    ...
                    <footer class="page-footer">
                        <p>Designed with <i class="ri-heart-3-fill heart-beat"></i> by DaXiang</p>
                        <p class="copyright">
